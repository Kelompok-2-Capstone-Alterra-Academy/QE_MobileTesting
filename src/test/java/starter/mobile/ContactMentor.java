...
public class ContactMentor extends BasePageObject {
    ...
    private By whatsappMentor() {
        return MobileBy.xpath("//android.view.View[@content-desc=\"Rizky Putra\n" +
                "Matematika Dasar\"]/android.widget.ImageView[2]");
    }
