...
public class SortCourses extends BasePageObject {
    ...
    private By sort() {
        return MobileBy.xpath("//android.widget.Button[@content-desc=\"Urutkan\"]");
    }
    private By newcourses() {
        return MobileBy.xpath("//android.widget.Button[@content-desc=\"Kursus Baru\"]");
    }
    private By major() {
        return MobileBy.xpath("//android.widget.Button[@content-desc=\"IPA\"]");
    }
